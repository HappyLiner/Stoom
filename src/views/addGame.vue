  ...
  <div class="addGame">
    <div class="w-full relative overflow-hidden">
      ...
      <div class="grid grid-cols-12">
        ...
        >
         <router-link to="/Prof" class="text-sm p-2 text-center">
            Information</router-link
          >
          <router-link
            to="/profSettings"
            class="text-sm p-2 text-center"
            >Settings</router-link
          >
          <router-link to="/addGame" class="text-sm p-2 text-center bg-yellow-500"
        ...
        >
          <div class="px-4 pt-4">
            <form action="#" class="flex flex-col space-y-8">
              <div>
                <h3 class="text-2xl">Send your crap</h3>
                <hr />
              </div>
              <div>
              ...
              <div class="w-full">
                <textarea
                  cols="30"
                  rows="10"
                  class="w-full py-1 px-2 bg-red-200"
                >
